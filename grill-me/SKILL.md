...
description: |
  ...
  USE FOR: stress-testing plans, design reviews, decision-making,
  getting grilled on architecture or feature design.
  DO NOT USE FOR: code-specific grilling with docs (use grill-with-docs),
