...
name: tdd
description: |
  Test-driven development with red-green-refactor loop. Builds features
  or fixes bugs one vertical slice at a time.
  USE FOR: building features with TDD, red-green-refactor, writing
  integration tests, test-first development, fixing bugs with tests.
  DO NOT USE FOR: generating bulk test files (use test-specific skills),
  architecture review, debugging without tests.
---
...
like a specification — "user can checkout with valid cart" tells you exactly what
...
private methods, or verify through external means (like querying a database
...
most. Focus testing effort on critical paths and complex logic, not every possible
edge case.
