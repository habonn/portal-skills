...
description: |
  ...
  USE FOR: saving tokens, brief responses, terse mode, less verbose output.
  DO NOT USE FOR: documentation writing, user-facing content, onboarding.
---
...
synonyms (big not extensive, fix not "implement a solution for"). Abbreviate common
terms (DB/auth/config/req/res/fn/impl). Strip conjunctions. Use arrows for
...
confirmations, multi-step sequences where fragment order risks misread, user asks to
