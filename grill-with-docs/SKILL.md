...
description: |
  ...
  USE FOR: stress-testing plans against project language, building shared
  vocabulary, documenting decisions, domain-driven design sessions.
  DO NOT USE FOR: non-code grilling (use grill-me), writing code, debugging.
---
